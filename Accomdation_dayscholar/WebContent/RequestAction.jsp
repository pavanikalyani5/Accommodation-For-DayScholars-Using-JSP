...
try {
	...
	PreparedStatement ps= con.prepareStatement("select * from applications where status='pending' ");  //sno , name are column name in db in cse table here s will be variable
	ResultSet rs=ps.executeQuery();
	%>
	<center><h2 style="color:white; background-color:skyblue;padding:10px ">REQUESTING APPLICATIONS</h2></center>
	...
	while(rs.next()){ 
		...
		<td>	
			<form action="RequestedUpdate.jsp">
