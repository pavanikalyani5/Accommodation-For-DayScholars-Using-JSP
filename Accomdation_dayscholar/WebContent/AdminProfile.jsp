...
try {
	...
	PreparedStatement ps= con.prepareStatement("select * from admin where name='"+s+"'");  //sno , name are column name in db in cse table here s will be variable
	ResultSet rs=ps.executeQuery();
	if(rs.next()){
		%>
		<br>
		<center><h3 style="color:green;text-transform:uppercase;">WELCOME TO <%=rs.getString("name")%></h3>
		</center>
		<%
		}
		}
