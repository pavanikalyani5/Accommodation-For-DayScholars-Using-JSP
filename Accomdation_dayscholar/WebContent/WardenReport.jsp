...
<body>
<center><h3 style="color:white; background-color:skyblue;padding:20px">WARDEN PORTAL</h3></center>
<div class="menu-bar">
<ul>
...
try {
	...
	<center><h3 style="color:white; background-color:skyblue; padding:20px"> ACCEPTED STUDENTS REPORT</h3></center>
		
		<center>
		
		 <table border="3" style="background-color:black;color:white;border-color:skyblue;">
